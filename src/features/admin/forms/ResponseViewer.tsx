...
const FormResponsesViewer = ({ formId, onBack }: {
    ...
    return (
        ...
        {/* Header */}
        <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-purple-800 rounded-3xl p-8 text-white">
            ...
            <div className="flex items-start justify-between">
                ...
                <div>
                    ...
                    <h2 className="text-2xl text-blue-100 font-medium mb-2">{formData.title}</h2>
